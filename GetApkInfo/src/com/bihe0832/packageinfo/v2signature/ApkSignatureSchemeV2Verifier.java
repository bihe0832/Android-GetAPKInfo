...
package com.bihe0832.packageinfo.v2signature;
...
public class ApkSignatureSchemeV2Verifier {
    ...
    private static X509Certificate[][] verify(RandomAccessFile apk)
        ...
        return verify(apk, signatureInfo);
    }
    ...
    private static X509Certificate[][] verify(
    	...
    	FileDescriptor apkFileDescriptor = null;
		try {
			apkFileDescriptor = apk.getFD();
    ...
    private static void verifyIntegrity(RandomAccessFile apk,
        ...
        try {
            actualDigests =
                    computeContentDigests(apk,apkFileDescriptor,
                            digestAlgorithms,
    ...
    private static byte[][] computeContentDigests(RandomAccessFile apk,FileDescriptor apkFileDescriptor,
        ...
        for (DataSource input : contents) {
            ...
            while (inputRemaining > 0) {
                ...
                try {
                	//计算一个DataSource从inputOffset开始的，chunkSize长度的内容的md5
                    input.feedIntoMessageDigests(apk.getChannel(), mds, inputOffset, chunkSize);
                } catch (IOException e) {
    ...
    public static ByteBuffer findApkSigningBlockWithId(ByteBuffer apkSigningBlock, int pairId)
            throws SignatureNotFoundException {
...
//        private static final long MEMORY_PAGE_SIZE_BYTES = OS.sysconf(OsConstants._SC_PAGESIZE);
        private static final long MEMORY_PAGE_SIZE_BYTES = 10 * 1024 *1024;
